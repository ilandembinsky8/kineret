...
public class TerrainStreamingZipUtil
{
#if UNITY_IPHONE
    ...
    public static void Unzip(string zipFilePath, string location)
    {
        ...
        try
        {
            using (ZipFile zip = Ionic.Zip.ZipFile.Read(zipFilePath))
            {

                zip.ExtractAll(location, Ionic.Zip.ExtractExistingFileAction.OverwriteSilently);
            }
        }
        catch (Exception e)
        {
            Debug.LogError("Error while extracting Data ... Try againe " + e);
