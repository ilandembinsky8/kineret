...
namespace GISTech.TerrainStreaming
{
    ...
    public static class TerrainStreamingGeometry
    {
        ...
        public static double GetPointInRelationToVectorValue(DVector2 a, DVector2 b, DVector2 p)
        {
            ...
            double determinant = TerrainStreamingMathUtility.Det2(x1, x2, y1, y2);
        ...
        public static bool IsQuadrilateralConvex(DVector2 a, DVector2 b, DVector2 c, DVector2 d)
        {
            ...
            bool abc = TerrainStreamingGeometry.IsTriangleOrientedClockwise(a, b, c);
            bool abd = TerrainStreamingGeometry.IsTriangleOrientedClockwise(a, b, d);
            bool bcd = TerrainStreamingGeometry.IsTriangleOrientedClockwise(b, c, d);
            bool cad = TerrainStreamingGeometry.IsTriangleOrientedClockwise(c, a, d);
        ...
        public static TerrainStreamingTriangle2 GenerateSupertriangle(HashSet<DVector2> points)
        {
            TerrainStreamingAABB2 aabb = new TerrainStreamingAABB2(new List<DVector2>(points));
            ...
            TerrainStreamingTriangle2 superTriangle = new TerrainStreamingTriangle2(t_BR, t_BL, t_T);
        ...
        public static bool HasPassedWaypoint(DVector2 wp1, DVector2 wp2, DVector2 p)
        {
            ...
            if (progress > 1.0f + TerrainStreamingMathUtility.EPSILON)
            {
                return true;
            }
            else
