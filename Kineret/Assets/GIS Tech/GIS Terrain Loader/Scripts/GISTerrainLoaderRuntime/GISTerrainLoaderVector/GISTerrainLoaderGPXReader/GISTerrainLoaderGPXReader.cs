...
namespace GISTech.GISTerrainLoader
{
                    ...
                    case XmlNodeType.Element:
                        ...
                        switch (Reader_.Name)
                        {
                            case "name":
                                ...
                                route.DataBase.Add(Reader_.Name, ReadContentAsString());
                                break;
                            case "cmt":
                    ...
                    case XmlNodeType.Element:
                        ...
                        switch (Reader_.Name)
                        {
                            case "name":
                                ...
                                track.DataBase.Add(Reader_.Name, ReadContentAsString());
                                break;
                            case "cmt":
    ...
    public class GpxPoint
    {
        ...
        {
            get { return Properties_.GetObjectProperty<string>("FeatureDataBase"); }
            set { Properties_.SetObjectProperty<string>("FeatureDataBase", value); }
        }
